...
public final class Biscuit extends UnverifiedBiscuit {
   ...
   * @return
   */
  public static org.biscuitsec.biscuit.token.builder.Biscuit builder(
   ...
   * @return
   */
  public Biscuit attenuate(org.biscuitsec.biscuit.token.builder.Block block, Algorithm algorithm)
      throws Error {
