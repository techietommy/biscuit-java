...
public abstract class Expression {
  ...
  public static Expression convertFrom(
      org.biscuitsec.biscuit.datalog.expressions.Expression e, SymbolTable symbols) {
    ...
    for (org.biscuitsec.biscuit.datalog.expressions.Op op : e.getOps()) {
      if (op instanceof org.biscuitsec.biscuit.datalog.expressions.Op.Value) {
        org.biscuitsec.biscuit.datalog.expressions.Op.Value v =
            (org.biscuitsec.biscuit.datalog.expressions.Op.Value) op;
        ...
        org.biscuitsec.biscuit.datalog.expressions.Op.Unary v =
            (org.biscuitsec.biscuit.datalog.expressions.Op.Unary) op;
        ...
        org.biscuitsec.biscuit.datalog.expressions.Op.Binary v =
            (org.biscuitsec.biscuit.datalog.expressions.Op.Binary) op;
  ...
  public abstract void toOpcodes(
      SymbolTable symbols, List<org.biscuitsec.biscuit.datalog.expressions.Op> ops);
  ...
  public static final class Unary extends Expression {
    ...
    public void toOpcodes(
      ...
      switch (this.op) {
        case Negate:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Unary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.UnaryOp.Negate));
          break;
        case Parens:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Unary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.UnaryOp.Parens));
          break;
        case Length:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Unary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.UnaryOp.Length));
          break;
        default:
  ...
  public static final class Binary extends Expression {
    ...
    public void toOpcodes(
      ...
      switch (this.op) {
        case LessThan:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.LessThan));
          break;
        case GreaterThan:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.GreaterThan));
          break;
        case LessOrEqual:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.LessOrEqual));
          break;
        case GreaterOrEqual:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.GreaterOrEqual));
          break;
        case Equal:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Equal));
          break;
        case NotEqual:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.NotEqual));
          break;
        case Contains:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Contains));
          break;
        case Prefix:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Prefix));
          break;
        case Suffix:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Suffix));
          break;
        case Regex:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Regex));
          break;
        case Add:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Add));
          break;
        case Sub:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Sub));
          break;
        case Mul:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Mul));
          break;
        case Div:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Div));
          break;
        case And:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.And));
          break;
        case Or:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Or));
          break;
        case Intersection:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Intersection));
          break;
        case Union:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.Union));
          break;
        case BitwiseAnd:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.BitwiseAnd));
          break;
        case BitwiseOr:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.BitwiseOr));
          break;
        case BitwiseXor:
          ops.add(
              new org.biscuitsec.biscuit.datalog.expressions.Op.Binary(
                  org.biscuitsec.biscuit.datalog.expressions.Op.BinaryOp.BitwiseXor));
          break;
        default:
          throw new RuntimeException("unmapped ops");
      }
