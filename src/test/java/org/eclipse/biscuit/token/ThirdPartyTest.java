...
public class ThirdPartyTest {
  ...
  @Test
  public void testPublicKeyInterning()
      throws NoSuchAlgorithmException,
          SignatureException,
          InvalidKeyException,
          CloneNotSupportedException,
    ...
    org.eclipse.biscuit.token.Block authorityBlock = authorityBuilder.build();
    ...
    builder2.addCheck(
        "check if fourth(1) trusting ed25519/"
